        ...
        <a-row :gutter="24">
          ...
          <a-col :span="8">
            <span style="float: left; overflow: hidden" class="table-page-search-submit-buttons">
              ...
              <a-button type="primary" @click="searchReset" icon="reload" style="margin: auto 8px">重置</a-button>
              <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>
              <a-button type="primary" icon="download" @click="handleExportXls('系统通告')" style="margin: auto 8px">
                导出
              </a-button>
              <!-- <a-upload
                name="file"
...
import { doReleaseData, doRevokeData } from '@tievd/cube-block/lib/api/api'
  ...
  data() {
    return {
      ...
      url: {
        ...
        reovkeDataUrl: 'sys/announcement/doRevokeData',
