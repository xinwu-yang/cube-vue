<template>
  <a-drawer title="数据权限规则" :width="drawerWidth" @close="onClose" :visible="visible">
    <!-- 抽屉内容的border -->
...
<script>
import { getPermissionRuleList, queryPermissionRule } from '@tievd/cube-block/lib/api/api'
