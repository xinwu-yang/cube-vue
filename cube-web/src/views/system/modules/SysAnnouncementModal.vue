        ...
        <a-row style="width: 100%">
          ...
          <a-col :span="24 / 2">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="消息类型">
              <j-dict-select-tag v-model="msgCategory" placeholder="请选择消息类型" dictCode="msg_category"/>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row style="width: 100%">
        ...
        <a-row style="width: 100%">
          <a-col :span="24">
            <a-form-item :labelCol="labelColX1" :wrapperCol="wrapperColX1" label="内容" class="j-field-content">
              <j-editor :disabled="disableSubmit" v-decorator="['msgContent', {}]" triggerChange></j-editor>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
    ...
    handleOk() {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          formData.msgCategory = this.msgCategory
          if (this.userType) {
