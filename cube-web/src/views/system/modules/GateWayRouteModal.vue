    ...
    <a-form-model ref="form" :layout="layout" :label-col="labelCol" :wrapper-col="wrapperCol" :model="router">
      ...
      <a-form-model-item prop="predicates" label="路由条件">
        ...
        <p class="btn" style="padding-top: 10px">
          <a-dropdown>
            <a-menu slot="overlay" class="ant-dropdown-bordered" @click="predicatesHandleMenuClick">
      ...
      <a-form-model-item prop="predicates" label="过滤器">
        ...
        <p class="btn" style="padding-top: 10px">
          <a-dropdown>
            <a-menu slot="overlay" class="ant-dropdown-bordered" @click="filterHandleMenuClick">
...
export default {
  ...
  data() {
    return {
      ...
      inputValue: '',
      url: {
        update: '/sys/gateway/route/updateAll',
        clear: '/sys/gateway/route/clearRedis',
      },
