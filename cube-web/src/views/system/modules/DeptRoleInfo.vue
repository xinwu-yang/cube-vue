        ...
        <a-row :gutter="10">
          <a-col :md="10" :sm="12">
            <a-form-item style="margin-left: 8px">
              <a-input placeholder="请输入部门角色" v-model.trim="queryParam.roleName"></a-input>
            </a-form-item>
          </a-col>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/sys/depart/role/list',
        delete: '/sys/depart/role/delete',
        deleteBatch: '/sys/depart/role/deleteBatch',
      },
    }
  },
  created() {},
