      ...
      <a-form :form="form">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="角色编码">
          <a-input
            ...
            v-decorator.trim="['roleCode', validatorRules.roleCode]"
          />
        </a-form-item>
...
import { addRole, editRole } from '@tievd/cube-block/lib/api/api'
      ...
      validatorRules: {
        ...
        roleCode: {
          rules: [
            ...
            { validator: debounce(this.validateRoleCode, 500) }
          ]
        },
        description: {
  ...
  methods: {
    ...
    validateRoleCode(rule, value, callback) {
      if (/[\u4E00-\u9FA5]/g.test(value)) {
        ...
        validateDuplicateValue('sys_role', 'role_code', value, this.model.id, callback, '该角色编码已存在')
      }
    }
  }
}
