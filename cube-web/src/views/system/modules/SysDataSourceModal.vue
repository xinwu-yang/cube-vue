<template>
  ...
  >
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="数据源编码">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="驱动类">
...
import { httpAction, postAction } from '@tievd/cube-block/lib/api/manage'
