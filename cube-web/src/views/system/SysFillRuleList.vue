...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/sys/fill/rule/list',
        test: '/sys/fill/rule/testFillRule',
        delete: '/sys/fill/rule/delete',
        deleteBatch: '/sys/fill/rule/deleteBatch',
        exportXlsUrl: '/sys/fill/rule/exportXls',
        importExcelUrl: '/sys/fill/rule/importExcel',
      },
    }
  },
  computed: {
