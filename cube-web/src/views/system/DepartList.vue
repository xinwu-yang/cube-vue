<template xmlns:background-color="http://www.w3.org/1999/xhtml">
  <a-row :gutter="10">
    <a-col :md="12" :sm="24" style="padding: 0">
      <a-card :bordered="false" style="min-height: 75vh">
        <!-- 按钮操作区域 -->
        ...
        <a-tab-pane tab="基本信息" key="1">
          <a-card :bordered="false" v-if="selectedKeys.length > 0">
            <a-form :form="form">
              ...
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="国标编码">
                <a-input placeholder="请输入国标编码" v-decorator="['gbCode', { initialValue: '' }]" />
              </a-form-item>
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="地区">
                <j-search-select-tag
                  placeholder="请选择地区"
                  v-decorator="['areaId', { initialValue: '' }]"
                  dict="sys_area,name,id"
                  :async="true"
                />
              </a-form-item>
...
import { queryDepartTreeList, searchByKeywords, deleteByDepartId } from '@tievd/cube-block/lib/api/api'
import { httpAction, deleteAction } from '@tievd/cube-block/lib/api/manage'
