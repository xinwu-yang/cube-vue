<template>
  <a-card :bordered="false">
    ...
    >
      <div
        v-has="'log:detail'"
        :slot="hasLogDetailPermission && queryParam.logType == 2 ? 'expandedRowRender' : ''"
        slot-scope="record"
        style="margin: 0"
      >
...
<script>
import { filterObj, hasPermissionAction } from '@tievd/cube-block/lib/utils/util'
...
export default {
  ...
  computed: {
    hasLogDetailPermission: () => hasPermissionAction('log:detail')
  },
