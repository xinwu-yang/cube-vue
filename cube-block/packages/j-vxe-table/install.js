import Vue from 'vue'
import { getEventPath } from '@tievd/cube-block/src/utils/util'
// import { getJVxeTableByLoop } from './index'
import { AllCells, JVXETypes } from './cellType'
// 引入 vxe-table
import 'xe-utils'
...
import JVxeTable from './index'
// const JVxeTable = getJVxeTableByLoop()
// VxeGrid所有的方法映射
