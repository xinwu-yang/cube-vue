  ...
  <div :class="boxClass">
    ...
    <div class="j-vxe-tool-button div" :size="btnSize">
      ...
      <template v-if="selectedRowIds.length > 0">
        <a-popconfirm v-if="showRemove" :title="`确定要删除这 ${selectedRowIds.length} 项吗?`" @confirm="trigger('remove')">
      ...
      <a class="link" v-if="showCollapse" @click="toggleCollapse" style="margin-left: 4px">
