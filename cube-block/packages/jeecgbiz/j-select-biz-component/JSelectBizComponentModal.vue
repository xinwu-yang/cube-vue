    ...
    <a-row :gutter="18">
      <a-col :span="16">
        ...
        <a-form layout="inline" class="j-inline-form">
          ...
          <a class="link" v-if="queryConfig.length > 0" @click="showMoreQueryItems = !showMoreQueryItems" style="margin-left: 8px">
        ...
        <a-card :title="'已选' + name" :bordered="false" :head-style="{ padding: 0 }" :body-style="{ padding: 0 }">
          <a-table size="middle" :rowKey="rowKey" bordered v-bind="selectedTable">
            <span slot="action" slot-scope="text, record, index">
              <a class="link" @click="handleDeleteSelected(record, index)">删除</a>
            </span>
          </a-table>
        </a-card>
      </a-col>
...
import { JeecgListMixin } from '@tievd/cube-block/src/mixins/JeecgListMixin'
import { cloneObject, pushIfNotExist } from '@tievd/cube-block/src/utils/util'
