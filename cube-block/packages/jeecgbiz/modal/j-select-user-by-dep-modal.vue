<template>
  <j-modal :width="modalWidth" :visible="visible" :title="title" switchFullscreen @ok="handleSubmit" @cancel="close" style="top:50px" cancelText="关闭">
...
import { queryDepartTreeList, getUserList, queryUserByDepId } from '@tievd/cube-block/src/api/api'
