<template>
  <j-modal :title="title" :width="modalWidth" :visible="visible" :confirmLoading="confirmLoading" switchFullscreen wrapClassName="j-popup-modal" @ok="handleSubmit" @cancel="handleCancel" cancelText="关闭">
        ...
        <a-row :gutter="24" v-if="showSearchFlag">
          ...
          <a-col :md="8" :sm="8">
            <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
              ...
              <a class="link" @click="handleToggleSearch" style="margin-left: 8px">
    ...
    <div class="ant-alert ant-alert-info" style="margin-bottom: 16px;">
      ...
      已选择&nbsp;
      <a class="link" style="font-weight: 600">{{ table.selectedRowKeys.length }}</a>
      项&nbsp;&nbsp;
      <a class="link" style="margin-left: 24px" @click="onClearSelected">清空</a>

      <a class="link" v-if="!showSearchFlag" style="margin-left: 24px" @click="onlyReload">刷新</a>
    </div>
...
import { filterObj } from '@tievd/cube-block/src/utils/util'
import { filterMultiDictText } from '@tievd/cube-block/src/utils/packages/JDictSelectUtil'
import { httpGroupRequest } from '@tievd/cube-block/src/api/GroupRequest.js'
